...
namespace AllTheSigils
{
    public partial class Plugin
    {
        ...
        private void AddFireStarter()
        {
            ...
            Texture2D tex_a1 = SigilUtils.LoadTextureFromResource(Art.void_Firestarter);
            Texture2D tex_a2 = SigilUtils.LoadTextureFromResource(Art.void_Firestarter_a2);
            int powerlevel = 2;
            ...
            void_Firestarter.ability = SigilUtils.CreateAbilityWithDefaultSettingsKCM(rulebookName, rulebookDescription, typeof(void_Firestarter), tex_a1, tex_a2, LearnDialogue,
                                                                                    true, powerlevel, LeshyUsable, part1Shops, canStack).ability;
            if (Plugin.GenerateWiki)
            {
                Plugin.SigilWikiInfos[void_Firestarter.ability] = new Tuple<string, string>("void_Firestarter", "");
            }
        }
    }
