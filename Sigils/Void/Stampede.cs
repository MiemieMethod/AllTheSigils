...
namespace AllTheSigils
{
    public partial class Plugin
    {
        ...
        private void AddStampede()
        {
            ...
            info.canStack = false;
            info.SetPixelAbilityIcon(SigilUtils.LoadImageAndGetTexture("void_stampede_a2"));
            info.flipYIfOpponent = true;

            Texture2D tex = SigilUtils.LoadImageAndGetTexture("void_stampede");



            AbilityManager.Add(OldVoidPluginGuid, info, typeof(void_stampede), tex);

            // set ability to behaviour class
            void_stampede.ability = info.ability;
