...
namespace AllTheSigils
{
    public partial class Plugin
    {
        ...
        private void AddRegen1()
        {
            ...
            info.canStack = false;
            info.SetPixelAbilityIcon(SigilUtils.LoadImageAndGetTexture("ability_regen_1_a2"));

            Texture2D tex = SigilUtils.LoadImageAndGetTexture("ability_regen_1");



            AbilityManager.Add(OldVoidPluginGuid, info, typeof(void_Regen1), tex);

            // set ability to behaviour class
            void_Regen1.ability = info.ability;
