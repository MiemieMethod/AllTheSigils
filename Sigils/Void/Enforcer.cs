...
namespace AllTheSigils
{
    public partial class Plugin
    {
        ...
        private void AddEnforcer()
        {
            ...
            info.canStack = false;
            info.SetPixelAbilityIcon(SigilUtils.LoadImageAndGetTexture("void_enforcer_a2"));
            info.flipYIfOpponent = true;

            Texture2D tex = SigilUtils.LoadImageAndGetTexture("void_enforcer");



            AbilityManager.Add(OldVoidPluginGuid, info, typeof(void_Instigator), tex);

            // set ability to behaviour class
            void_Instigator.ability = info.ability;
