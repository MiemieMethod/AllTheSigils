...
namespace AllTheSigils
{
    public partial class Plugin
    {
        ...
        private void AddTribalTutor()
        {
            ...
            Texture2D tex = SigilUtils.LoadImageAndGetTexture("void_TribeTutor");



            AbilityManager.Add(OldVoidPluginGuid, info, typeof(void_TribalTutor), tex);

            // set ability to behaviour class
            void_TribalTutor.ability = info.ability;
    ...
    public class TribalTutorPatch
    {
        ...
        public static void Postfix(ref Texture __result, ref CardInfo info, ref AbilityInfo ability)
        {
            if (ability.ability == void_TribalTutor.ability)
            {
                if (info != null)
                {
                    Texture2D tex1 = SigilUtils.LoadImageAndGetTexture("void_TribeTutor_bird");

                    Texture2D tex2 = SigilUtils.LoadImageAndGetTexture("void_TribeTutor_canine");

                    Texture2D tex3 = SigilUtils.LoadImageAndGetTexture("void_TribeTutor_hooved");

                    Texture2D tex4 = SigilUtils.LoadImageAndGetTexture("void_TribeTutor_insect");

                    Texture2D tex5 = SigilUtils.LoadImageAndGetTexture("void_TribeTutor_reptile");

                    Texture2D tex6 = SigilUtils.LoadImageAndGetTexture("void_TribeTutor_none");
