...
namespace AllTheSigils
{
    public partial class Plugin
    {
        ...
        private void AddThief()
        {
            ...
            const string rulebookDescription = "[creature] will try to steal a random default sigil from a card in the opposing lane when played, or at the start of the owner's turn until it does.";
