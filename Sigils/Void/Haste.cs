...
namespace AllTheSigils
{
    public partial class Plugin
    {
        ...
        private void AddHaste()
        {
            ...
            info.canStack = false;
            info.SetPixelAbilityIcon(SigilUtils.LoadImageAndGetTexture("void_haste_a2"));
            Texture2D tex = SigilUtils.LoadImageAndGetTexture("void_haste");



            AbilityManager.Add(OldVoidPluginGuid, info, typeof(void_haste), tex);

            // set ability to behaviour class
            void_haste.ability = info.ability;
