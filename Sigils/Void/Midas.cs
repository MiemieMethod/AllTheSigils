...
namespace AllTheSigils
{
    public partial class Plugin
    {
        ...
        private void AddMidas()
        {
            ...
            Texture2D tex_a1 = SigilUtils.LoadTextureFromResource(Art.void_Midas);
            Texture2D tex_a2 = SigilUtils.LoadTextureFromResource(Art.void_Midas_a2);
            int powerlevel = 2;
            ...
            void_Midas.ability = SigilUtils.CreateAbilityWithDefaultSettingsKCM(rulebookName, rulebookDescription, typeof(void_Midas), tex_a1, tex_a2, LearnDialogue,
                                                                                    true, powerlevel, LeshyUsable, part1Shops, canStack).ability;
            if (Plugin.GenerateWiki)
            {
                Plugin.SigilWikiInfos[void_Midas.ability] = new Tuple<string, string>("void_Midas", "");
            }
