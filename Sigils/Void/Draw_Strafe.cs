    ...
    public class void_DrawStrafe : DrawCreatedCard
    {
        ...
        public static CardInfo GetRandomChoosableCardWithCost(int randomSeed)
        {
            ...
            if (flag1)
            {
                ...
                list.AddRange(CardLoader.GetUnlockedCards(CardMetaCategory.GBCPack, CardTemple.Nature).FindAll((CardInfo x) => x.HasAbility(Ability.StrafePush)));
                list.AddRange(CardLoader.GetUnlockedCards(CardMetaCategory.GBCPack, CardTemple.Nature).FindAll((CardInfo x) => x.HasAbility(Ability.SquirrelStrafe)));
                list.AddRange(CardLoader.GetUnlockedCards(CardMetaCategory.GBCPack, CardTemple.Nature).FindAll((CardInfo x) => x.HasAbility(Ability.MoveBeside)));

                list.AddRange(CardLoader.GetUnlockedCards(CardMetaCategory.GBCPack, CardTemple.Tech).FindAll((CardInfo x) => x.HasAbility(Ability.Strafe)));
                list.AddRange(CardLoader.GetUnlockedCards(CardMetaCategory.GBCPack, CardTemple.Tech).FindAll((CardInfo x) => x.HasAbility(Ability.StrafePush)));
                list.AddRange(CardLoader.GetUnlockedCards(CardMetaCategory.GBCPack, CardTemple.Tech).FindAll((CardInfo x) => x.HasAbility(Ability.SquirrelStrafe)));
                list.AddRange(CardLoader.GetUnlockedCards(CardMetaCategory.GBCPack, CardTemple.Tech).FindAll((CardInfo x) => x.HasAbility(Ability.MoveBeside)));

                list.AddRange(CardLoader.GetUnlockedCards(CardMetaCategory.GBCPack, CardTemple.Undead).FindAll((CardInfo x) => x.HasAbility(Ability.Strafe)));
                list.AddRange(CardLoader.GetUnlockedCards(CardMetaCategory.GBCPack, CardTemple.Undead).FindAll((CardInfo x) => x.HasAbility(Ability.StrafePush)));
                list.AddRange(CardLoader.GetUnlockedCards(CardMetaCategory.GBCPack, CardTemple.Undead).FindAll((CardInfo x) => x.HasAbility(Ability.SquirrelStrafe)));
                list.AddRange(CardLoader.GetUnlockedCards(CardMetaCategory.GBCPack, CardTemple.Undead).FindAll((CardInfo x) => x.HasAbility(Ability.MoveBeside)));
            }
