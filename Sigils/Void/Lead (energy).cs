...
namespace AllTheSigils
{
    public partial class Plugin
    {
        ...
        private void AddLeadEnergy()
        {
            ...
            Texture2D tex_a1 = SigilUtils.LoadTextureFromResource(Art.void_Lead_Energy);
            ...
            var test = SigilUtils.CreateAbilityWithDefaultSettingsKCM(rulebookName, rulebookDescription, typeof(void_Lead_Energy), tex_a1, tex_a2, LearnDialogue,
                                                                                    true, powerlevel, LeshyUsable, part1Shops, canStack);
            test.activated = true;
            test.pixelIcon = SigilUtils.LoadSpriteFromResource(Art.void_Lead_Energy_a2);
