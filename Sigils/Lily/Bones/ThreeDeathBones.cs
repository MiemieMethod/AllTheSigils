    ...
    public partial class Plugin
    {
        public void AddThreeDeathBones()
        {
            AbilityInfo info = AbilityManager.New(
                                   OldLilyPluginGuid,
                                   "Bone prince 3",
                                   "When a card bearing this sigil dies, 3 bones are rewarded instead of 1.",
                                   typeof(ThreeDeathBones),
                                   GetTexture("threedeathbones")
                               );
            info.SetPixelAbilityIcon(GetTexture("threedeathbones", true));
            info.powerLevel = 1;
